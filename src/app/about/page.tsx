...
export const metadata: Metadata = {
  title: "About ClaimPilot | AI Claims Triage Showcase",
  description:
    "How ClaimPilot demonstrates AI product management for the Allstate Digital Product Manager role. Built by Marcelo Otero.",
  openGraph: {
    title: "About ClaimPilot",
    description:
      "Why I built an AI claims triage agent for the Allstate Digital Product Manager role. By Marcelo Otero.",
  },
};
